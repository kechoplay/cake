...
class ViewTest extends TestCase
{
    ...
    public function testGetTemplate()
    {
        ...
        $expected = Plugin::path('TestTheme') . 'src' . DS . 'Template' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $ThemeView->getLayoutFileName();
        $this->assertPathEquals($expected, $result);

        $ThemeView->layoutPath = 'rss';
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS . 'Layout' . DS . 'rss' . DS . 'default2.ctp';
        $result = $ThemeView->getLayoutFileName();
        $this->assertPathEquals($expected, $result);

        $ThemeView->layoutPath = 'Email' . DS . 'html';
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS . 'Layout' . DS . 'Email' . DS . 'html' . DS . 'default2.ctp';
        $result = $ThemeView->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
        ...
        $expected = Plugin::path('Company/TestPluginThree') . 'src' . DS . 'Template' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $ThemeView->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
    }
    ...
    public function testPluginGetTemplate()
    {
        ...
        $expected = Plugin::path('TestPlugin') . 'src' . DS . 'Template' . DS . 'Layout' . DS . 'default2.ctp';
    ...
    public function testPluginThemedGetTemplate()
    {
        ...
        $expected = $themePath . 'Layout' . DS . 'default2.ctp';
    ...
    public function testCamelCasePluginGetTemplate()
    {
        ...
        $expected = $pluginPath . 'src' . DS . 'Template' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $View->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
    }
    ...
    public function testGetLayoutFileName()
    {
        ...
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $View->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
    ...
    public function testGetLayoutFileNamePlugin()
    {
        ...
        $expected = TEST_APP . 'Plugin' . DS . 'TestPlugin' . DS . 'src' . DS .
            'Template' . DS . 'Layout' . DS . 'default2.ctp';
    ...
    public function testGetLayoutFileNamePrefix()
    {
        ...
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS .
            'FooPrefix' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $View->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
        ...
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS .
            'FooPrefix' . DS . 'BarPrefix' . DS . 'Layout' . DS . 'default2.ctp';
        $result = $View->getLayoutFileName();
        $this->assertPathEquals($expected, $result);
